...
function changeColor() {
  ...
  for (let i = 0; i < collection.length; i++) {
    collection[i].style.color = oppositeColor;
  }

  var colorStater = document.getElementById('current-color')
  colorStater.innerHTML = newValue;
  colorStater.style.color = newValue;
  colorStater.style.backgroundColor = oppositeColor;

  var oppositeStater = document.getElementById('opposite-color')
  oppositeStater.innerHTML = oppositeColor;
}
